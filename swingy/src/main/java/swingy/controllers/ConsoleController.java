...
public class ConsoleController 
{
    ...
    public boolean winFight(){
        ...
        while ((villainHP > 0 && player.getPlayerHP() > 0)){
            int attacker = ((int)Math.round(Math.random() * (1)));
            if (attacker == 1){ //villain attacks
                player.setPlayerHP(player.getPlayerHP() - player.getPlayerLevel());
                System.out.println("villain attacked "+player.getPlayerHP());
            }
            else if (attacker == 0){ //hero attacks
                villainHP = villainHP - (player.getPlayerLevel() + 2);
                System.out.println("hero attacked "+villainHP);
            }
        }
            ...
            while (choiceValid == false){
                ...
                try{
                    ...
                    if (choice == 1){ //fight
                        ...
                        int odds = ((int)Math.round(Math.random() * (1)));
                        if (odds == 1){
